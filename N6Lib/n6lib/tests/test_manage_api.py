...
from n6lib.manage_api._manage_api import (
...
from n6lib.pki_related_test_helpers import (
    _load_ca_cert_pem,
    _load_ca_key_pem,
...
class _RevokeCertTestBase(_BaseAPIActionTest):
    ...
    def setUp(self):
        self.basic_api_action_test_setup(manage_api_cert_class=CertificateFromDatabase)
